...
let Restaurants = [
    Restaurant(name: "Isaba Taifu", location: "G/F, 39 Fife Street, Kin Wong Mansion, Mong Kok", image: "IT", reviews: ["Great pasta!", "Loved the ambiance."]),
    Restaurant(name: "M.Y Majesty", location: "G/F, 15 Fuk Wa Street, Sham Shui Po", image: "MYM", reviews: ["Best burgers in town!", "Friendly staff."]),
